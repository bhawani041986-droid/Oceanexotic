...
export default function SellerSplash() {
  ...
  return (
    <View className="relative flex-1 bg-[#020617]">
      ...
      <LinearGradient colors={["rgba(52,211,153,0.1)", "#020617", "#020617"]} className="absolute inset-0" />
      ...
      <View className="flex-1 justify-between px-6 py-16">
        ...
        <View className="items-center my-auto space-y-6">
          <View className="rounded-[32px] border border-emerald-400/20 bg-white/5 p-1 max-w-[340px]">
            <View className="rounded-[30px] bg-[#020617]/90 px-6 py-8 items-center border border-white/5 shadow-2xl">
              <Text className="text-[36px] font-black italic text-center tracking-tight text-white leading-none">
                SELLER <Text className="text-emerald-400">HUB</Text>
              </Text>
              <Text className="mt-3 text-[10px] font-black uppercase tracking-widest text-center text-emerald-400">
                Vendor Management Portal
              </Text>
              <Text className="mt-4 text-[11px] text-slate-400 font-medium text-center leading-relaxed">
                Manage your daily catch, process direct orders, and coordinate global logistics from the central dock.
              </Text>
            </View>
          </View>
        </View>
