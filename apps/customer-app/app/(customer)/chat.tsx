...
export default function CustomerChatScreen() {
 ...
 className="p-2 mr-2 bg-white/5 border border-white/5 active:scale-95"
 >
 ...
 <View className="py-16 items-center justify-center opacity-30 border border-white/5 bg-slate-900/20">
 ...
 className="p-4 border mb-3 bg-slate-950/40 flex-row justify-between items-center active:bg-slate-900/50"
 style={{ borderColor: borderColor }}
 >
 <View className="flex-1 pr-3">
 <View className="flex-row items-center gap-2 mb-1">
 <View className="w-2 h-2 bg-emerald-500" />
 ...
 <View className="mb-2 overflow-hidden bg-slate-800" style={{ width: 200, height: 150 }}>
 <Image 
 ...
 className="flex-1 h-10 border bg-slate-900/50 px-3 text-xs font-bold text-white uppercase tracking-wider"
 style={{ borderColor: borderColor }}
 />
 <Pressable
 onPress={handleSendMessage}
 disabled={sending || !msgText.trim()}
 className="w-10 h-10 bg-[#7C3AED] items-center justify-center ml-2.5 active:bg-[#6D28D9]"
 >
 {sending ? (
