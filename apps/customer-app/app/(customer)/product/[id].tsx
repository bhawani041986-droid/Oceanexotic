...
export default function ProductDetailScreen() {
 ...
 <View className="mt-6 p-4 -[20px] border" style={{ backgroundColor: 'rgba(16, 185, 129, 0.03)', borderColor: 'rgba(16, 185, 129, 0.15)' }}>
 ...
 <View key={idx} className="bg-blue-500/10 px-1.5 py-1 border border-blue-500/20">
 ...
 <View className="w-12 h-12 items-center justify-center border" style={{ backgroundColor: `${colors.primary}20`, borderColor: `${colors.primary}40` }}>
 ...
 <View className="flex-row items-center gap-2">
 <View className="w-8 h-8 items-center justify-center" style={{ backgroundColor: `${colors.primary}20` }}>
