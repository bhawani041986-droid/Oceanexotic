...
export default function OrderDetailsScreen() {
 ...
 <View className="mb-6 overflow-hidden -[24px] border border-sky-500/20 bg-slate-950/40">
 <LinearGradient
 ...
 <View
 className={cn("h-6 w-6 items-center justify-center border",
 isDone
 ...
 <Text
 className={cn("text-[8px] font-black uppercase tracking-wide text-center leading-tight max-w-[70px]",
 ...
 {idx < arr.length - 1 && (
 <View
 className={cn("h-[2px] w-8 mx-1 mb-4",
 ...
 {images.map((img, idx) => (
 <View key={idx} className="relative w-16 h-16 overflow-hidden border" style={{ borderColor: colors.border }}>
