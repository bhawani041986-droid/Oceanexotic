...
export default function CheckoutScreen() {
 ...
 {idx < 2 && (
 <View
 className={cn("flex-1 h-[1px] mx-1 mb-4",
 ...
 {selected && (
 <View className="w-4 h-4 items-center justify-center" style={{ backgroundColor: primaryColor }}>
 ...
 <View className="w-5 h-5 items-center justify-center" style={{ backgroundColor: primaryColor }}>
...
function StepCard({ stepNum, label, active, done, summary, onEdit, children }: StepCardProps) {
 ...
 <Text
 className={cn("text-sm font-black uppercase",
 active ?"text-foreground" :"text-muted-foreground"
 )}
 >
 {label}
