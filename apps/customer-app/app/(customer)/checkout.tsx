...
export default function CheckoutScreen() {
  ...
  return (
    <View className="flex-1 bg-background">
      ...
      <ScrollView
        className="flex-1"
        contentContainerClassName="px-4 py-6 gap-5 pb-32"
      >
        ...
        >
          ...
          <View className="bg-secondary/40 border border-white/10 p-4 mb-6 gap-2">
            ...
            <View className="flex-row justify-between">
              <Text className="text-xs text-muted-foreground">
                {t("shipping_and_handling") || "Shipping & Handling"}
              </Text>
          ...
          <View className="bg-secondary/40 border border-white/10 p-6 items-center gap-4">
            ...
            <Text className="text-[10px] text-muted-foreground italic text-center leading-relaxed">
              {t("by_finalizing_you_authorize_delivery") ||
