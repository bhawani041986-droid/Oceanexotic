  ...
  return (
    ...
    >
      <Svg width="100%" height="100%" style={StyleSheet.absoluteFill}>
        <Path
          d="M0,80 Q120,40 240,80 T480,80 T720,80"
        ...
        />
        <Path
          d="M0,320 Q100,280 200,320 T400,320 T600,320"
          stroke={colors.primary}
          strokeWidth="0.8"
          opacity="0.05"
          fill="none"
        />
        <Path
          d="M0,580 Q90,620 180,580 T360,580 T540,580"
          stroke={colors.primary}
          strokeWidth="1"
          opacity="0.06"
          fill="none"
...
export default function RecipesListScreen() {
  ...
  const [selectedRegion, setSelectedRegion] = useState<
    "ALL" | "SOUTH INDIAN" | "BENGALI" | "TELUGU" | "ANDAMAN LOCAL"
  >("ALL");
  ...
  const filteredRecipes = useMemo(() => {
    return RECIPES_DB.filter((recipe) => {
      ...
      const matchesPrep =
        selectedPrep === "ALL" ||
        recipe.prepType.toUpperCase() === selectedPrep;

      const matchesRegion =
        selectedRegion === "ALL" ||
        recipe.region.toUpperCase() === selectedRegion;
        ...
        <View className="p-5 space-y-5">
          ...
          >
            ...
            <TextInput
              ...
              placeholder={
                ...
                "Search fish, recipes or ingredients..."
              }
          ...
          <View className="space-y-2">
            <Text className="text-[9px] font-black uppercase tracking-widest text-slate-400">
              {t("preparation_style") || "Preparation Style"}
            </Text>
            <ScrollView
              horizontal
          ...
          <View className="space-y-2">
            <Text className="text-[9px] font-black uppercase tracking-widest text-slate-400">
              {t("cuisine_region") || "Cuisine / Region"}
            </Text>
            <ScrollView
              horizontal
              showsHorizontalScrollIndicator={false}
          ...
          {filteredRecipes.length > 0 ? (
            filteredRecipes.map((recipe) => (
              <Pressable
                ...
                className="relative h-48 overflow-hidden border shadow-xl justify-end"
                style={{ borderColor: colors.border }}
              >
                <Image
                ...
                <View className="relative z-10 p-5 gap-2">
                  <View className="flex-row gap-2 flex-wrap">
                    ...
                    >
                      <Text className="text-[8px] font-black uppercase text-emerald-400">
                        {recipe.region}
                      </Text>
                    </View>
                    <View
                    ...
                    >
                      <Text className="text-[8px] font-black uppercase text-cyan-400">
                        {recipe.prepType}
                      </Text>
                    </View>
