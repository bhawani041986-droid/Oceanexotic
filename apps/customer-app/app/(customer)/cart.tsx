...
export default function CartScreen() {
 ...
 {img ? (
 <Image source={{ uri: img }} className="h-20 w-20" contentFit="cover" />
 ) : (
 <View className="h-20 w-20 items-center justify-center" style={{ backgroundColor: colors.bgAlt }}>
 ...
 style={{ borderColor: colors.border, backgroundColor: colors.card }}
 >
 <Image source={{ uri: addonImg }} className="h-16 w-full" contentFit="cover" />
