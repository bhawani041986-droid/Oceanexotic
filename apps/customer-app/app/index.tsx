    ...
    <View className="relative flex-1 bg-background">
      ...
      <View className="flex-1 justify-between px-6 py-16">
        ...
        <View className="items-center my-auto space-y-6">
          <View className="border border-white/10 bg-white/5 p-1 max-w-[340px]">
            <View className="bg-[#020617]/90 px-6 py-8 items-center border border-white/5 shadow-2xl">
              <Text className="text-[36px] font-black italic text-center tracking-tight text-white leading-none">
                {t("harbor_sync") || "HARBOR SYNC"}
              </Text>
              <Text
                className="mt-3 text-[10px] font-black uppercase tracking-widest text-center"
                style={{ color: colors.primary }}
              >
                {t("vibrant_port_blair_fish_exchange") ||
                  "Vibrant Port Blair Fish Exchange"}
              </Text>
              <Text className="mt-4 text-[11px] text-slate-400 font-medium text-center leading-relaxed">
                {t("connect_directly_with_fleets") ||
