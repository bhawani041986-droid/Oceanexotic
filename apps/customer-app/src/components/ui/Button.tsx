...
export function Button({
 ...
 className={cn("h-14 w-full items-center justify-center active:opacity-90 relative overflow-hidden",
 ...
 <Text
 className={cn("text-xs font-black tracking-[0.2em] uppercase relative z-10",
