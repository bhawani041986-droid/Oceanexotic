...
export function OceanReelsFeed({ variant ="feed", videoId }: OceanReelsFeedProps) {
 ...
 <View className="w-6 h-6 items-center justify-center bg-primary/95" style={{ backgroundColor: colors.primary }}>
 ...
 key={vid.id}
 onPress={() => setActiveVideoId(isActive ? null : vid.id)}
 className="relative -[16px] overflow-hidden bg-black shadow-md border"
 style={{
 width: 120,
 height: 200,
