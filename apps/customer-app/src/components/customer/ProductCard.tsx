...
export function ProductCard({ product, onAdd, onSelectCut, compact }: ProductCardProps) {
 ...
 {onSelectCut ? (
 <Pressable onPress={onSelectCut} className="px-3 py-2 overflow-hidden relative" style={{ backgroundColor: colors.primary }}>
 ...
 <Pressable onPress={onAdd} disabled={outOfStock} className="px-3 py-2 opacity-100 disabled:opacity-40 overflow-hidden relative" style={{ backgroundColor: colors.primary }}>
