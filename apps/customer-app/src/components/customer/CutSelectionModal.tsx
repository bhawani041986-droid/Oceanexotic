            ...
            <ScrollView className="mt-4 max-h-64">
              {options.map((cut) => (
                <Pressable
                  ...
                  className={cn(
                    "mb-2 flex-row items-center justify-between border px-4 py-3",
                ...
                >
                  ...
                  <Text className="text-sm font-black italic text-primary">
                    ₹{cut.final_price}
                  </Text>
                </Pressable>
              ))}
              {options.length === 0 ? (
                <Text className="py-6 text-center text-xs text-muted-foreground">
                  {t("no_cut_options") ||
                    "No cut options in catalog for this product."}
                </Text>
              ) : null}
            </ScrollView>
          )}
          ...
          {!loading && options.length > 0 && (
            <View className="mt-2 mb-4 flex-row items-center justify-between rounded-xl border border-white/10 bg-background/50 px-4 py-3">
              ...
              <View className="flex-row items-center gap-4">
                ...
                <Text className="text-base font-black text-foreground w-12 text-center">
                  {weight} KG
                </Text>
                <TouchableOpacity
