      ...
      <div className="space-y-[10px] md:space-y-10 pt-4 md:pt-10 pb-20 px-4 md:px-0 animate-fade-in">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-[10px] md:gap-6 md:border-b md:border-[var(--foreground)]/5 md:pb-10">
          ...
          <div className="flex items-center gap-4">
            <Button variant="outline" className="h-12 px-8 text-[10px] font-black tracking-widest uppercase flex items-center gap-3 border-[var(--foreground)]/10">
          ...
          {selectedSeller && (
            <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
              ...
              <motion.div 
                ...
                className="relative w-full max-w-2xl bg-bg-secondary border border-[var(--foreground)]/10 rounded-[32px] shadow-2xl overflow-hidden"
              >
                <div className="p-8 space-y-8">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-4">
                      <div className="w-14 h-14 bg-primary/10 border border-primary/20 rounded-[20px] flex items-center justify-center text-primary font-black">
                        {selectedSeller.name?.[0] || 'M'}
                      </div>
                      <div>
                        <h3 className="text-xl font-black text-[var(--foreground)] tracking-tight uppercase italic leading-none mb-1">Node Audit Dossier</h3>
                        <p className="text-[9px] font-black text-slate-500 uppercase tracking-widest leading-none italic">{selectedSeller.name} • {selectedSeller.id}</p>
                      </div>
                    </div>
                    <Button 
                      variant="outline" 
                                 ...
                                 <div className="flex items-center gap-4">
                                    ...
                                    <div className="flex items-center gap-1">
                                       ...
                                       <Button 
                                         ...
                                         onClick={() => window.open(`http://localhost:8081/FISH_MARKET/${doc.file_path}`, '_blank')}
                                       >
