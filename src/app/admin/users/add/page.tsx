...
export default function AdminAddUserPage() {
  ...
  const handleSave = () => {
    ...
    // Simulate Sovereign Identity Commissioning
    setTimeout(() => {
    ...
    <div className="space-y-12 animate-fade-in pb-20">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 border-b border-[var(--foreground)]/5 pb-10">
        ...
        <div className="flex gap-4">
           <Button variant="ghost" className="h-12 px-8 text-[10px] font-black tracking-widest uppercase">DISCARD IDENTITY</Button>
           <Button 
             onClick={handleSave}
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                 <div className="space-y-2">
                    ...
                    <div className="relative">
                       <Input placeholder="USR-XXXX" className="h-14 pl-12 bg-bg-secondary border-primary/20 font-black text-primary tracking-widest" />
           ...
           <Card className="p-10 space-y-8 bg-bg-secondary/40 border-[var(--foreground)]/5">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                 <div className="space-y-2">
                    ...
                    <Input placeholder="ENTER CITIZEN NAME..." className="h-14 bg-bg-secondary border-[var(--foreground)]/10 font-bold" />
                 </div>
                 <div className="space-y-2">
                    <label className="text-[10px] font-black text-[var(--foreground)] uppercase tracking-widest ml-1">Communication Node (Email)</label>
                    <div className="relative">
                       <Input placeholder="CITIZEN@OCEAN.COM" className="h-14 pl-12 bg-bg-secondary border-[var(--foreground)]/10 font-bold" />
                 ...
                 <div className="space-y-2">
                    ...
                    <select defaultValue="GLOBAL CITIZEN (CUSTOMER)" className="w-full h-14 bg-bg-secondary border border-[var(--foreground)]/10 rounded-[16px] px-4 text-[10px] font-black uppercase tracking-widest text-[var(--foreground)] outline-none focus:border-primary/50 transition-all">
                       ...
                       <option value="SEA SCOUT (MODERATOR)">SEA SCOUT (MODERATOR)</option>
                    </select>
                 </div>
              </div>
           </Card>
