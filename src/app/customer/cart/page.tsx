                          ...
                          {item.metadata && (item.metadata.primary || item.metadata.cleaning || item.metadata.cut_type) && (
                            <div className="flex flex-wrap gap-2 mt-1">
                               ...
                               {item.metadata.cleaning && (
                                  <span className="text-[8px] md:text-[9px] font-black bg-[var(--foreground)]/10 px-2 py-0.5 rounded-sm uppercase tracking-widest text-[var(--c-text-secondary)]">{String(item.metadata.cleaning).replace('_', ' ')}</span>
                               )}
                            </div>
                          )}
