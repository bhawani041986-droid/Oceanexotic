...
export const MASTER_PRODUCT_REGISTRY: Product[] = [
  ...
  {
    id: "mirgal-carp",
    name: "Mirgal (Mrigal Carp)",
    tagline: "Freshwater Carp",
    category: "FRESHWATER FISH",
    price: 400,
    originalPrice: 480,
    stock: 50,
    description: "Fresh Mrigal Carp sourced directly from local rivers. Available in whole fish, steaks, and fillets.",
    image: "/images/products/mirgal/mirgal_whole.jpg",
    images: [
      "/images/products/mirgal/mirgal_whole.jpg",
      "/images/products/mirgal/mirgal_steaks.jpg",
      "/images/products/mirgal/mirgal_fillet.jpg",
      "/images/products/mirgal/mirgal_cooked.jpg"
    ],
    gallery: [],
    badge: "River Fresh",
    rating: 4.8,
    ...
    freshness: 100,
    weight: "1kg",
    seller: "OceanExotic Seller",
    sellerId: "SEL-2001",
    discount: null,
    status: "ACTIVE",
    nutrition: { protein: "18g", omega3: "250mg", calories: "95 kcal", fat: "1.5g" },
    trustBadges: ["Fresh Catch", "Sustainably Harvested"],
    recipes: [],
    variants: [
      { id: "v1", label: "500g", price: 220, status: "ACTIVE" },
      { id: "v2", label: "1kg", price: 400, status: "ACTIVE" }
    ],
    customerReviews: [],
    addons: ["ADD-001", "ADD-002", "ADD-004", "ADD-005", "ADD-006"],
    cutTypes: ["Whole", "Curry Cut", "Cleaned"]
  ...
  {
    id: "kukari-scad",
    name: "Kukari (Indian Scad)",
    tagline: "Seafresh Indian Scad",
    category: "SEAWATER FISH",
    price: 400,
    originalPrice: 480,
    stock: 50,
    description: "Indian Scad fish (Kukari) sourced fresh daily from local harbors. Lean and protein-rich.",
    image: "/images/products/kukari.webp",
    images: [],
    gallery: [],
    badge: "Ocean Catch",
    rating: 4.7,
    ...
    discount: null,
    status: "ACTIVE",
    nutrition: { protein: "19g", omega3: "280mg", calories: "110 kcal", fat: "3g" },
    trustBadges: ["Fresh Catch", "100% Traceable"],
    recipes: [],
    variants: [
      { id: "v1", label: "500g", price: 220, status: "ACTIVE" },
      { id: "v2", label: "1kg", price: 400, status: "ACTIVE" }
  ...
  {
    id: "chanda-kukari",
    name: "Chanda Kukari (Indian Scad)",
    tagline: "Vibrant Silver Scad",
    category: "SEAWATER FISH",
    price: 400,
    originalPrice: 480,
    stock: 50,
    description: "Vibrant Silver Scad (Chanda Kukari) fresh from the shore. Exceptional taste and texture.",
    image: "/images/products/chanda_kukari.webp",
    images: [],
    gallery: [],
    badge: "Shore Catch",
    rating: 4.7,
